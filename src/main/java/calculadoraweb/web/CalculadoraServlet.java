...
import calculadoraweb.core.Calculadora;
...
public class CalculadoraServlet extends HttpServlet {
    ...
    private void processar(final HttpServletRequest req,
        ...
        if (MODO_CALCULAR.equals(req.getParameter(PARAMETRO_MODO_CALCULO))) {
            Double num1 = getParametroDouble(req, PARAMETRO_NUM_1, "N&uacute;mero 1",
                    erros);
            Double num2 = getParametroDouble(req, PARAMETRO_NUM_2, "N&uacute;mero 2",
                    erros);
